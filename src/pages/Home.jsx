...
import { Search, CheckCircle, Map, ArrowRight, Shield, Truck, Clock, Euro } from 'lucide-react';
...
const Home = () => {
    ...
    return (
        <div className="bg-background text-gray-900 flex flex-col">
            {/* Hero Section */}
            <section
                className="relative h-[350px] md:h-[600px] flex items-center justify-center bg-primary text-white overflow-hidden bg-cover bg-center"
                style={{
                    backgroundImage:
            ...
            >
                ...
                <div className="container mx-auto px-4 md:px-6 max-w-6xl relative z-10 text-center">
                    <h1
                        className="text-2xl md:text-4xl lg:text-6xl font-bold mb-3 md:mb-6 leading-tight"
                        style={{
                            textShadow:
                    ...
                    <p
                        className="text-sm md:text-xl lg:text-2xl text-gray-200 mb-5 md:mb-10 max-w-3xl mx-auto px-4"
                        style={{
                            textShadow:
                    ...
                    <div className="flex flex-col md:flex-row items-center justify-center gap-3 md:gap-4 px-4">
                        <Link
                            to="/vehicules"
                            className="bg-accent hover:bg-accent/90 text-white px-6 md:px-8 py-3 md:py-4 rounded-full font-bold text-sm md:text-lg transition-transform transform hover:scale-105 w-full md:w-auto shadow-lg"
                        >
                            {t('hero.cta_vehicles')}
                        </Link>
                        <Link
                            to="/contact"
                            className="bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white border border-white/30 px-6 md:px-8 py-3 md:py-4 rounded-full font-bold text-sm md:text-lg transition-colors w-full md:w-auto shadow-lg"
                        >
                            {t('hero.cta_quote')}
                        </Link>
                    </div>
            ...
            {/* Search Bar */}
            <section className="relative -mt-10 mb-4 md:mb-6 z-20 order-0">
            ...
            <section className="py-8 md:py-12 bg-white order-1 md:order-1">
                <div className="container mx-auto px-6 max-w-6xl">
            ...
            <section className="py-8 md:py-12 bg-gray-50 order-2 md:order-2">
                <div className="container mx-auto px-6 max-w-6xl">
            ...
            {/* How It Works */}
            <section className="py-12 md:py-20 bg-primary text-white relative overflow-hidden order-3 md:order-3">
            ...
            {/* Europe Delivery */}
            <section className="py-8 md:py-12 bg-gray-50 order-4 md:order-4">
                <div className="container mx-auto px-6 max-w-6xl">
            ...
            {/* Stats */}
            <section className="py-8 bg-accent text-white relative overflow-hidden order-5 md:order-5">
